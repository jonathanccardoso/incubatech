...
<html>
    ...
    <body>
        ...
        <div id="show-collaborator" class="content scaffold-show" role="main">
            ...
            <f:display bean="collaborator" />
            <g:form resource="${this.collaborator}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.collaborator}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
