...
<html>
    ...
    <body>
        ...
        <div id="edit-collaborator" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.collaborator}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.collaborator}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.collaborator}" method="PUT">
                <g:hiddenField name="version" value="${this.collaborator?.version}" />
                <fieldset class="form">
                    <f:all bean="collaborator"/>
                </fieldset>
